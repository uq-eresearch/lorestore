$(document).ready(function() {
	var sampleQuery1 = "SELECT * WHERE {?c a <http://www.openarchives.org/ore/terms/ResourceMap>}";
	var sampleQuery2 = "SELECT * WHERE {?a a <http://www.openannotation.org/ns/Annotation>}";
	var sampleQuery3 = "SELECT * WHERE {?r a <http://www.openannotation.org/ns/Reply>}";
	var flintConfig = {
		"interface": {
			"toolbar": false,
			"menu": false
	...
	var flintEd = new FlintEditor("flint-test", "../flintsparql/images", flintConfig);
});