      ...
      <div class="content">
        ...
        <div class="row">
          <div class="span10">
			...
			<p>The web interface makes use of <a href="http://twitter.github.com/bootstrap/">Bootstrap</a>, <a href="http://jquery.com/">jQuery</a> and <a href="https://github.com/TSO-Openup/FlintSparqlEditor">Flint SPARQL editor</a>.</p>
