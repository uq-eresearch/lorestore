...
<html lang="en">
  <head>
    <title>${sitename} Add Identity</title>
        ...
        <div class="row">
          <div class="span10">
          	 <ul class="breadcrumb">
			 	 ...
			 	 <li class="active">Add identity</li>
		     </ul>
            <p>To add a secondary identity to your account, enter the identity Uri and the domain
		     below and click 'Add Identity'.  Your password is required as an extra security 
		     measure.</p>
		  <form action="${emmet}" method="post">
		  <input type="hidden" name="action" value="addIdentity">
		  <table>
			<tr>
