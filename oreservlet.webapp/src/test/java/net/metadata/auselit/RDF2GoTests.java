...
import oreservlet.servlets.CommonTestRecords;
import oreservlet.servlets.ORETypeFactory;
...
public class RDF2GoTests {
	...
	public Model save(Model model) throws RepositoryException {
		Repository remoteRepo = ORETypeFactory.getRemoteRepo();
	...
	public void connectToRemoteSesame() throws Exception {
		Repository myRepo = ORETypeFactory.getRemoteRepo();
